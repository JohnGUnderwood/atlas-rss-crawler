...
if [ ! -f .env ]; then
    echo "backend/.env file does not exist. Please create it using backend/example.env and re-run this script."
    exit 1
fi
...
echo "If these paths don't look right check the 'chrome-headless-shell' and 'chromedriver' folders and uppdate your backend/.env file"
